...
router.post('/', (req, res) => {
    // expects {UN: 'Example','Beetlejuice', 'Lernantino, Em: 'example@gmail.com', 'sayitthreetimes@gmail.com', 'lernantino@gmail.com' PW: 'something1234', 'example1234','password1234' }
    User.create({
